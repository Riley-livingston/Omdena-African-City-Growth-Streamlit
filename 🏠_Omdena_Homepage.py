...
st.write("""<p style='margin:0in;font-size:15px;font-family:"Helvetica Neue",serif;color:black;border:none;'><span style='font-family:"Arial",sans-serif;'>In this project, we aim to introduce how a group can use our data and research to build a full model that predicts urban growth, city maintenance, and environmental monitoring.&nbsp;</span></p>
